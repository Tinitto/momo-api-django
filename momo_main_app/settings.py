"""
Django settings for momo_main_app project.
...
SECRET_KEY = '#!h&yjwr8zgi5b%b(0h7dtlzlpuv#d0x+55rk@$6(clnxbm2z2'
...
ROOT_URLCONF = 'momo_main_app.urls'
...
WSGI_APPLICATION = 'momo_main_app.wsgi.application'
