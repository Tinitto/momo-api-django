"""
Tests for the transaction type of products of the MTN Momo Open API
like collections, disbursements and remittances
It has been ported by Martin Ahindura from the mtn-pay-js Typescript package
https://github.com/sopherapps/mtn-pay-js/blob/master/src/__tests__/transaction.spec.ts
"""
"""
